  ...
  return (
    <div className="container-fluid about">
      <div className="row py-5">
        ...
        <div className="col-5 my-5 d-flex flex-column justify-content-start aboutText">
          <div className="h2 text-warning fw-bold pb-3">
            <span className="border-bottom border-5">About Us</span>
          </div>
          <p className="para text-light mr-5">
          ...
          <ul className="p-0 d-flex flex-wrap justify-content-start aboutcontact">
            <li>
